...
public:
	...
	// Draw & Blit
	bool Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float scale = 1.0f, float speed = 1.0f, double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX, SDL_RendererFlip Flip=SDL_FLIP_NONE) const;
